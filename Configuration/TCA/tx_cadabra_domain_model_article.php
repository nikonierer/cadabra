...
return array(
    ...
    'columns' => array(
        ...
        'price_influencer' => array(
            'label' => 'LLL:EXT:cadabra/Resources/Private/Language/locallang_db.xlf:article.price_influencer',
            'config' => array(
                'type' => 'select',
                ...
                'wizards' => array(
                    ...
                    'add' => array(
                        'type' => 'script',
                        'title' => 'LLL:EXT:cadabra/Resources/Private/Language/locallang_db.xlf:article.tx_cadabra_domain_model_price_influencer.basedOn_add',
                        'icon' => 'add.gif',
                        'params' => array(
                            'table' => 'tx_cadabra_domain_model_price_influencer',
                            'pid' => '###CURRENT_PID###',
                            'setValue' => 'prepend'
                        ),
                        'module' => array(
