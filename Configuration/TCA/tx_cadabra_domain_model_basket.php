...
return array(
    'ctrl' => array(
        'title' => 'LLL:EXT:cadabra/Resources/Private/Language/locallang_db.xlf:tx_cadabra_domain_model_basket',
        'label' => 'uid',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        ...
        'searchFields' => '',
        'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('cadabra') . 'Resources/Public/Icons/tx_cadabra_domain_model_basket.gif'
    ),
    'interface' => array(
    ...
    'columns' => array(
        ...
        'l10n_parent' => array(
            ...
            'config' => array(
                ...
                'foreign_table_where' => 'AND tx_cadabra_domain_model_basket.pid=###CURRENT_PID### AND tx_cadabra_domain_model_basket.sys_language_uid IN (-1,0)',
            ),
        ),
