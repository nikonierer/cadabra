...
/**
 * RelativeScaledPriceInfluencer
 */
class RelativeScaledPriceInfluencer extends AbstractScaledPriceInfluencer implements PriceInfluencerInterface
{
    /**
     * @var float
     */
    protected $relativeAmount;
